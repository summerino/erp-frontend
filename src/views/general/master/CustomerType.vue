    ...
    <v-card v-if="main">
      <v-card-title class="indigo--text text--lighten-2 pb-1">
        <v-row dense>
          ...
          <v-col cols="12" md="1">
            <export-excel title="Daftar Tipe Pelanggan" :grid="grid" :gridDefOpts="gridDefOpts" ref="exportExcel"></export-excel>
          </v-col>
...
export default {
  ...
  created: function () {
    this.getList()
    auth.getAction(this.endpoint, this.menuId.customerType)
      .then((response) => {
