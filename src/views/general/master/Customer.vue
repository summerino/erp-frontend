                    ...
                    <v-tooltip bottom>
                      <template v-slot:activator="{ on, attrs }">
                        <v-btn
                          ...
                          v-on="on"
                          v-shortkey="['ctrl', 'i']"
                          :disabled="data.isActive === false || ((data.action === 'edit' && !auth.allowUpdate) && !auth.allowCreate)"
                          class="blue--text"
                          small
                          tile
                          @click="addItem"
                        ...
                        <v-tooltip bottom>
                          <template v-slot:activator="{ on, attrs }">
                            <v-btn
                              v-bind="attrs"
                              v-on="on"
                              :disabled="data.isActive === false || item.isDefault === true || ((data.action === 'edit' && !auth.allowUpdate) && !auth.allowCreate)"
                              color="red"
                              icon
                              small
...
export default {
  ...
  created: function () {
    ...
    auth.getAction(this.endpoint, this.menuId.customer)
      .then((response) => {
