                    ...
                    <v-list-item>
                      <v-list-item-title>
                        <export-excel
                          ...
                          title="Daftar Laporan Kinerja Kunjungan"
                        ></export-excel>
                      </v-list-item-title>
                    </v-list-item>
                  </v-list>
...
export default {
  ...
  created: function () {
    ...
    auth.getAction(this.endpoint, this.menuId.mobileVisitPerformanceReport)
      .then((response) => {
  ...
  methods:{
    ...
    getList() {
      ...
      api.getAll(this.endpoint.mobileSales.visitPerformanceReport, {
        params: {
