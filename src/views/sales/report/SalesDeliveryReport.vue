        ...
        <v-card>
          <v-card-title class="indigo--text text--lighten-2 pb-1">
                    ...
                    <v-list-item>
                      <v-list-item-title>
                        <export-excel
                          ...
                          title="Daftar Laporan Surat Jalan"
                        ></export-excel>
                      </v-list-item-title>
                    </v-list-item>
                  </v-list>
            ...
            <v-row v-else no-gutters>
              <v-col cols="12" md="8">
                Laporan Surat Jalan - Detail {{ this.data.typeName }} - {{ this.data.detailName}}
              </v-col>
                    ...
                    <v-list-item>
                      <v-list-item-title>
                        <export-excel
                          ...
                          :grid="grid"
                          :gridDefOpts="gridDefOpts"
                          :title="`Daftar Laporan Surat Jalan - Detail ${ this.data.typeName } - ${ this.data.detailName }`"
                        ></export-excel>
                      </v-list-item-title>
                    </v-list-item>
                  </v-list>
...
export default {
  ...
  methods:{
    ...
    getList() {
      ...
      api.getAll(this.endpoint.sales.doReport, {
        params: {
          type: this.data.type,
