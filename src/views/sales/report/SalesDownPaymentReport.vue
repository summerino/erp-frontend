...
export default {
  ...
  data: () => ({
    ...
    statuses: [{ id: 'PP', name: 'Belum Dibayarkan' }, { id: 'OS', name: 'Belum Habis Terpakai' },
      { id: 'A', name: 'Belum Digunakan' }, { id: 'PU', name: 'Digunakan Sebagian' }, { id: 'FU', name: 'Digunakan Seluruhnya' }],
    statusesRetur:[{ id: 'PP', name: 'Belum Dibayarkan' }, { id: 'FU', name: 'Sudah Dibayarkan' }],
