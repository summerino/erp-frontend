                  ...
                  <template v-slot:activator="{ on, attrs }">
                    ...
                    >
                      ...
                      <v-list class="cursor-pointer">
                        <v-list-item>
                          <v-list-item-title>
                            <export-excel xcel title="Daftar Laporan Piutang" :grid="grid" :gridDefOpts="gridDefOpts" ref="exportExcel"></export-excel>
                          </v-list-item-title>
                        </v-list-item>
                      </v-list>
                    </v-menu>
...
export default {
  ...
  created: function () {
    ...
    this.getList()
    auth.getAction(this.endpoint, this.menuId.arReport, [this.action.print])
      .then((response) => {
