                    ...
                    <v-list-item>
                      <v-list-item-title>
                        <export-excel
                          ...
                          :grid="grid"
                          :gridDefOpts="gridDefOpts"
                          :title="mainDet === 1 ? `Daftar Laporan Neraca - Akun Detail - ${ this.data.coaCode } - ${ this.data.coaName }` : `Daftar Laporan Neraca - Akun Detail - ${ this.data.coaCode } - ${ this.data.coaName } - Jurnal Detail - ${ this.data.vouFrom }`"
                        ></export-excel>
                      </v-list-item-title>
                    </v-list-item>
                  </v-list>
