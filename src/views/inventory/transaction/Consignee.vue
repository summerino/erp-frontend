                          ...
                          <v-tooltip bottom>
                            <template v-slot:activator="{ on, attrs }">
                              <v-btn
                                ...
                                v-on="on"
                                v-shortkey="['ctrl', 'i']"
                                :disabled="isVoid || ((data.action === 'edit' && !auth.allowUpdate) && !auth.allowInsert)"
                                class="blue--text"
                                small
                                tile
                                @click="addItem"
...
export default {
  ...
  created: function () {
    ...
    this.getItemLists()
    auth.getAction(this.endpoint, this.menuId.consignee, [this.action.insert, this.action.update, this.action.void, this.action.changeDate])
      .then((response) => {
