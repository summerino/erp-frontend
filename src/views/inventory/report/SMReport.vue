...
export default {
  ...
  data: () => ({
    ...
    whColumn: [
      ...
      { text: 'Qty Awal', value: 'qtyBegin', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Qty Masuk', value: 'qtyIn', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Qty Keluar', value: 'qtyOut', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Qty Akhir', value: 'qtyEnd', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
    ...
    typeColumn: [
      ...
      { text: 'Satuan', value: 'unit', divider: true, width: '100', excelColWidth:'12' },
      { text: 'Qty Awal', value: 'qtyBegin', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Qty Terima (PO)', value: 'qtyInPO', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Qty Terima (Retur)', value: 'qtyInRtn', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Qty Transfer +', value: 'qtyInTS', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Qty Konsinyasi +', value: 'qtyInCNEE', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Qty Peny. +', value: 'qtyInADJ', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Qty Kirim (SJ)', value: 'qtyOutDO', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Qty Kirim (DI)', value: 'qtyOutDI', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Qty Kirim (Retur)', value: 'qtyOutRtn', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Qty Transfer -', value: 'qtyOutTS', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Qty Konsinyasi -', value: 'qtyOutCNEE', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Qty Peny. -', value: 'qtyOutADJ', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Qty Akhir', value: 'qtyEnd', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Persediaan Awal', value: 'invBegin', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Persediaan Terima (PO)', value: 'invInPO', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Persediaan Terima (Retur)', value: 'invInRtn', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Persediaan Transfer +', value: 'invInTS', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Persediaan Konsinyasi +', value: 'invInCNEE', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Persediaan Peny. +', value: 'invInADJ', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Persediaan Kirim (SJ)', value: 'invOutDO', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Persediaan Kirim (DI)', value: 'invOutDI', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Persediaan Kirim (Retur)', value: 'invOutRtn', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Persediaan Transfer -', value: 'invOutTS', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Persediaan Konsinyasi -', value: 'invOutCNEE', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Persediaan Peny. -', value: 'invOutADJ', align: 'right', divider: true, width: '100', excelColWidth:'20', isCurrency: true },
      { text: 'Persediaan Akhir', value: 'invEnd', align: 'right', width: '100', excelColWidth:'20', isCurrency: true }
    ],
    smColumn: [
